...
((generic_command
   command: (command_name)
   arg: (curly_group)) @conceal
 (#lua-match? @conceal "\\mathrm{[abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ]}")
 (#set-pairs! @conceal conceal
  "\\mathrm{a}" "a"
  "\\mathrm{b}" "b"
  "\\mathrm{c}" "c"
...
((generic_command
   command: (command_name)
   arg: (curly_group)) @conceal
 (#lua-match? @conceal "\\mathbf{[abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ]}")
 (#set-pairs! @conceal conceal
  "\\mathbf{a}" "𝐚"
  "\\mathbf{b}" "𝐛"
  "\\mathbf{c}" "𝐜"
...
((generic_command
   command: (command_name)
   arg: (curly_group)) @conceal
 (#lua-match? @conceal "\\bm{[abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ]}")
 (#set-pairs! @conceal conceal
  "\\bm{a}" "𝐚"
  "\\bm{b}" "𝐛"
  "\\bm{c}" "𝐜"
